        ...
        <div class="container">
            <div class="row text-white pt-5 pb-5">
                ...
                <div class="col-xl-6 col-lg-8 col-md-8 col-sm-10 mx-auto text-center  p-4">
                    ...
                    <div class="px-2">
                        <form action='/admin/postvideonews' method="POST" enctype="multipart/form-data" class="justify-content-center">
                            @csrf
                            <strong><u>Enter News Details</u></strong>
                            <div class="form-group">
                                <label class="sr-only">News Name</label>
                                <input type="text" name="name" class="form-control" placeholder="Enter News Name">
                            </div>
                            <div class="form-group">
                                <label class="sr-only">News Type</label>
                                <input type="text" name="news_type" class="form-control" placeholder="Enter news type here">
                            </div>
                            <div class="form-group">
                                <label class="sr-only">News Link</label>
                                <input type="text" name="videolink" class="form-control" placeholder="Enter video News Link Here">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check-inline">
                                    ...
                                    <input type="checkbox" class="form-check-input" name="balcony" value="Balcony">Political
                                    </label>
                                </div>
                                <div class="form-check-inline">
                                    <label class="form-check-label">
                            ...
                            <button type="submit" name="submit" class="btn btn-primary btn-lg">Post Video News</button>
                        </form>
                    </div>
                </div>
            </div>
